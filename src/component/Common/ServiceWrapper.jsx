...
const ServiceWrapper = ({
  ...
  return (
    <div
      className={`bg-no-repeat bg-contain bg-bottom rounded-[37.02px] ${bg} py-7 md:py-10 px-8 ${height} flex flex-col justify-between`}
      style={
        showBgImg
          ? {
